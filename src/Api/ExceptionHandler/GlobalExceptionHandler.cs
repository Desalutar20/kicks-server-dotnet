    ...
    IProblemDetailsService problemDetailsService) : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            ValidationException ex => ("Validation failed", "Validation failed", HttpStatusCode.BadRequest, ex.Errors
            ...
            _ => ("An error occurred", "Something went wrong", HttpStatusCode.InternalServerError, null)
        };
