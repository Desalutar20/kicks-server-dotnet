...
internal sealed class UserConfiguration : IEntityTypeConfiguration<DomainUser>
{
    public void Configure(EntityTypeBuilder<DomainUser> builder)
    {
        ...
        builder
            ...
            .HasConversion(
                hashedPassword => hashedPassword != null ? hashedPassword.Value : null,
                value => value != null ? HashedPassword.Create(value).Value : null
            )
        ...
        builder
            ...
            .HasConversion(
                ...
                value => value != null ? Enum.Parse<Gender>(value, true) : null
            )
            .IsRequired(false);
        ...
        builder
            ...
            .HasConversion(
                googleId => googleId != null ? googleId.Value : null,
                value => value != null ? ProviderId.Create(value).Value : null
            )
        ...
        builder
            ...
            .HasConversion(
                facebookId => facebookId != null ? facebookId.Value : null,
                value => value != null ? ProviderId.Create(value).Value : null
            )
            .HasMaxLength(ProviderId.MaxLength);
