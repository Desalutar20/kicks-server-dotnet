        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_discount_value_percent", "type != 'percent' OR (discount_value > 0 AND discount_value < 100)");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delivery_address_apartment = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_order_status", "status IN ('pending', 'paid', 'shipped', 'delivered', 'cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_order_payment_status", "status IN ('pending', 'completed', 'failed', 'expired', 'refunded', 'cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_status", "status IN ('pending', 'rejected', 'approved')");
                    table.ForeignKey(
