...
public class SignUpTests(ApiFactory factory) : TestApp(factory)
{
    ...
    public async ValueTask Should_ReturnCreated_When_RequestIsValid()
    {
        ...
        var response = await SignUp(request, TestContext.Current.CancellationToken);
    ...
    public async ValueTask Should_ReturnBadRequest_When_RequestIsInvalid(string field, SignUpRequest invalidRequest)
    {
